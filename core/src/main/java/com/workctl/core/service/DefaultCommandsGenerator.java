...
public class DefaultCommandsGenerator {

        public static void populate(CommandService service) {
                ...
                add(service, "workctl-task", "Start Task", "workctl task start <project> <id>",
                                "Moves a task to In Progress");
                add(service, "workctl-task", "Complete Task", "workctl task done <project> <id>",
                                "Marks a task as Done");
                add(service, "workctl-task", "Delete Task", "workctl task delete <project> -id <id>",
                                "Permanently deletes a task by ID");

                add(service, "workctl-subtask", "Add Subtask",
                ...
                add(service, "workctl-subtask", "Toggle Subtask Done",
                                "workctl task subtask done <project> <task-id> <idx>",
                                "Toggles completion state of a subtask");
                add(service, "workctl-subtask", "Delete Subtask",
                                "workctl task subtask delete <project> <task-id> <idx>",
                ...
                add(service, "workctl-config", "Show Config", "workctl config show",
                                "Lists all currently set config values");
                ...
                add(service, "workctl-cmd", "Add Tracked CLI Command",
                                ...
                                "Saves a useful command to reference later");
                add(service, "workctl-cmd", "List Tracked Commands", "workctl cmd list",
                                "Lists all saved snippet commands");
        }

        private static void add(CommandService service, String category, String title, String cmdRaw, String notes) {
                CommandEntry entry = new CommandEntry(category, title, cmdRaw, notes, "workctl");
