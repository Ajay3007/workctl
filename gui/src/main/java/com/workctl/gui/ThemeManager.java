...
public class ThemeManager {
    ...
    public static String toggleIcon() {
        return isDark() ? "☀" : "🌙";
    }

    // ── Semantic colors (for programmatic HTML content) ───────────

    public static String htmlBg() {
        return isDark() ? "#0d0f17" : "#f8fafc";
    }

    public static String htmlSurface() {
        return isDark() ? "#1a1d2e" : "#ffffff";
    }

    public static String htmlBorder() {
    ...
    public static String htmlMuted() {
        return isDark() ? "#a0aec0" : "#475569";
    }

    public static String htmlDim() {
        return isDark() ? "#718096" : "#64748b";
    }

    public static String htmlHeading() {
        return isDark() ? "#f7fafc" : "#0f172a";
    }

    public static String htmlCode() {
        return isDark() ? "#1a2535" : "#f1f5f9";
    }

    public static String htmlCodeText() {
        return isDark() ? "#63b3ed" : "#1d4ed8";
    }

    public static String htmlLink() {
        return isDark() ? "#63b3ed" : "#2563eb";
    }

    public static String htmlQuote() {
        return isDark() ? "rgba(37,99,235,0.12)" : "rgba(37,99,235,0.07)";
    }

    public static String htmlQuoteText() {
    ...
    public static String cardBgHover() {
        return isDark() ? "#212540" : "#f8fafc";
    }
    ...
    public static String textMuted() {
        return isDark() ? "#718096" : "#475569";
    }

    public static String infoBtnBg() {
        return isDark() ? "#2d3748" : "#f1f5f9";
    }

    public static String infoBtnText() {
        return isDark() ? "#63b3ed" : "#2563eb";
    }

    public static String infoBtnBorder() {
